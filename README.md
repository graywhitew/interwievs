...
> Docker vs Виртуальная машина (ВМ):
> Docker использует концепцию контейнеризации, где каждое приложение и его зависимости запускаются в изолированных контейнерах, разделяющих общее ядро операционной системы. Это делает
> контейнеры более легковесными и быстрыми в запуске, по сравнению с ВМ.  
> Виртуальные машины полностью эмулируют отдельные виртуальные компьютеры, каждый с собственной операционной системой. Они более изолированны и могут работать с разными ОС, но требуют
> больше ресурсов и времени для запуска.

> Docker Image: Docker Image - это шаблон или образ контейнера, который содержит исполняемый код, зависимости и другие компоненты, необходимые для запуска приложения.
> Docker Container: Docker Container - это экземпляр Docker Image, который работает в изолированном окружении. Контейнеры обеспечивают легковесную и консистентную среду для выполнения
> приложений.  
> Docker Daemon: Docker Daemon - это фоновый процесс, который управляет операциями Docker на хостовой машине. Он обрабатывает запросы API Docker и управляет контейнерами, образами и
> другими ресурсами.  
> Docker Registry: Docker Registry - это хранилище Docker Images. Один из наиболее известных регистров - Docker Hub. Вы также можете создать собственный частный реестр для хранения
> образов.  
> Dockerfile: Dockerfile - это текстовый файл, который содержит инструкции для создания Docker Image. Он определяет базовый образ, устанавливает зависимости, копирует файлы и
> выполняет другие задачи для подготовки образа.
> .dockerignore: Файл .dockerignore позволяет указать файлы и директории, которые Docker не должен копировать в контейнер при создании образа.


> Основные команды Docker: 
> docker build: Создание Docker Image из Dockerfile.  
> docker run: Запуск контейнера из Docker Image.  
> docker ps: Просмотр запущенных контейнеров.  
> docker images: Просмотр списка доступных Docker Images.  
> docker pull: Загрузка Docker Image из Docker Registry.  
> docker push: Загрузка Docker Image в Docker Registry.  
> docker exec: Выполнение команды внутри запущенного контейнера.  
> docker stop, docker start: Остановка и запуск контейнера.  
